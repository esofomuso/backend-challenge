...
RSpec.describe HeadingsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: heading.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      heading = Heading.create! valid_attributes
      get :edit, params: {id: heading.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Heading" do
        expect {
          post :create, params: {heading: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {heading: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested heading" do
        heading = Heading.create! valid_attributes
        put :update, params: {id: heading.to_param, heading: new_attributes}, session: valid_session
        heading.reload
      ...
      it "redirects to the heading" do
        heading = Heading.create! valid_attributes
        put :update, params: {id: heading.to_param, heading: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        heading = Heading.create! valid_attributes
        put :update, params: {id: heading.to_param, heading: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested heading" do
      heading = Heading.create! valid_attributes
      expect {
        delete :destroy, params: {id: heading.to_param}, session: valid_session
      }.to change(Heading, :count).by(-1)
    end
